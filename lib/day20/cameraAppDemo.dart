...
//? Step 1: Create the CameraController by a getting a specific camera from the list of
//? set the resolution for taking the photo
...
//? Use a FutureBuilder to display a loading spinner until the controller has finished
...
//? If the Photo has been taken then display that Photo on the Screen
            await Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => DispayPictureScreen(imagePath: image.path),
            ));
          } catch (e) {
