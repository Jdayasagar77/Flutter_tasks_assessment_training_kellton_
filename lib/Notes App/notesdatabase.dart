...
//? Returns the _database is already created else it will initialize the database and it
// will return the DB
...
//?Method to initialize the database
  Future<Database> _initializeDB(String filePath) async {
    final dbPath =
        await getDatabasesPath(); //? Returns the Database path based on the Platform i.e.
// Android or iOS
    final path = join(
...
//?This method helps insert a map of [values] into the specified [table] and returns the
