                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: const DecorationImage(
                                    image:
                                        AssetImage('assets/images/IN-AP.png'),
                                    fit: BoxFit.cover),
                              ),
                            ),
                            Positioned(
              ...
              GridView.count(
                ...
                children: [
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/images/IN-AP.png', 123, 456, 1),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/images/IN-AP.png', 123, 456, 2),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/images/IN-AP.png', 123, 456, 3),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/images/IN-AP.png', 123, 456, 4),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/images/IN-AP.png', 123, 456, 5),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/images/IN-AP.png', 123, 456, 6),
                ],
              )
            ],
          )
